...
## Story 1 — Secure searchable foundation

- [x] Repository policy, protections, PRD, and verification contract.
- [x] D1/R2 schema and official-source ingestion boundary.
- [x] Full metadata synchronization and body-coverage ledger.
- [x] Deterministic full-text, revision, status, and eligibility APIs.
